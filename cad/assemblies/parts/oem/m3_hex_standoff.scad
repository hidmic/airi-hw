...
module mM3x30mmHexThreadedStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x30mmHexThreadedStandoffDatasheet());
}
...
module mM3x30mmHexStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x30mmHexStandoffDatasheet());
}
...
module mM3x40mmHexThreadedStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x40mmHexThreadedStandoffDatasheet());
}
...
module mM3x40mmHexStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x40mmHexStandoffDatasheet());
}
...
module mM3x15mmHexThreadedStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x15mmHexThreadedStandoffDatasheet());
}
...
module mM3x15mmHexStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x15mmHexStandoffDatasheet());
}
...
module mM3x10mmHexThreadedStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x10mmHexThreadedStandoffDatasheet());
}
...
module mM3x10mmHexStandoff() {
     color("darkgoldenrod") render() pmMetricHexStandoff(datasheet=vM3x10mmHexStandoffDatasheet());
}
