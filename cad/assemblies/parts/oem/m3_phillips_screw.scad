...
module mM3x6mmPhillipsScrew() {
     color("silver") render() import("stl/m3x6mm_phillips_screw.stl");
}

module mM3x12mmPhillipsScrew() {
     color("silver") render() import("stl/m3x12mm_phillips_screw.stl");
}

module mM3x20mmPhillipsScrew() {
     color("silver") render() import("stl/m3x20mm_phillips_screw.stl");
}
