...
function vChassisBaseCoverDatasheet() =
     let(chassis_datasheet=vChassisBaseDatasheet(),
         ...
         height=(property(chassis_datasheet, "height") -
                 ...
                 bay_height),
         support_diameter=10, wireway_width=20, wireway_conduit_width=30,
     ...
     [["height", height], ["bay_height", bay_height],
      ["panel_length", 40], ["panel_width", 80], ["panel_angular_offset", 0],
      ["panel_r_offset", -outer_wireway_radius/2],
      ["outer_wireway_radius", outer_wireway_radius],
      ["inner_wireway_radius", inner_wireway_radius],
      ...
      ["fastening_r_offset", inner_wireway_radius - support_diameter/2 - min_thickness/2],
      ["sma_conn_locations", sma_conn_locations],
      ["pole_block_diameter", 60], ["pole_block_taper_angle", 25],
      ["pole_socket_diameter", 50], ["pole_socket_taper_angle", 15],
