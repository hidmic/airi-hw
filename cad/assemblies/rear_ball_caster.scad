...
module mRearBallCaster() {
     ...
     m50mmBallCasterBase();
          /* translate([0, 0, standoff_length/2 + yoke_base_thickness]) { */
          /*      rotate([0, 180, 0]) { */
          /*           let(spring_length=15) { */
          /*                translate([0, 0, yoke_base_thickness]) { */
     ...
     /* translate([0, 0, base_thickness + mount_height + standoff_length]) { */
     /*      rotate([0, 180, 0]) { */
     /*           let(spring_length=15) { */
...
/* caster_yoke_datasheet = v50mmBallCasterYokeDatasheet(); */

     /* mount_height = property(caster_yoke_datasheet, "mount_height"); */
     /* mount_offset = property(caster_yoke_datasheet, "mount_offset"); */
     ...
     /* mount_height = property(caster_yoke_datasheet, "mount_height"); */
     /* mount_offset = property(caster_yoke_datasheet, "mount_offset"); */
     /* base_thickness = property(caster_yoke_datasheet, "base_thickness"); */
     /* main_diameter = property(caster_yoke_datasheet, "main_diameter"); */
     /* main_height = property(caster_yoke_datasheet, "main_height"); */

     /* standoff_length = property(vM3x40mmHexThreadedStandoffDatasheet(), "length"); */
